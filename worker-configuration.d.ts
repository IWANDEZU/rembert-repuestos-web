/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 8e2d21144c73bbc595c93b143e71e87e)
// Runtime types generated with workerd@1.20260820.1 2026-08-20 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CATALOG_IMPORT_QUEUE: Queue;
	API_RATE_LIMITER: RateLimit;
	CHECKOUT_RATE_LIMITER: RateLimit;
	FAVORITES_RATE_LIMITER: RateLimit;
	ADMIN_RATE_LIMITER: RateLimit;
	ACCOUNT_DELETE_RATE_LIMITER: RateLimit;
	POS_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;

        ...
        <AuthProvider>
          <CartProvider>
            ...
            <nav className="navbar">
              ...
              {/* Bottom Menu */}
              <ul className="navbar__menu main-container" style={{ display: "flex", justifyContent: "center", alignItems: "center", whiteSpace: "nowrap", flexWrap: "nowrap", width: "100%", padding: "0.2rem 0", fontSize: "0.60rem" }}>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>INICIO</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=lubricantes" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>LUBRICANTES</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=filtros" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>FILTROS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=frenos-y-suspension" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>{"FRENOS\u00A0Y\u00A0SUSPENSIÓN"}</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/radiadores" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>RADIADORES</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/servicio-tecnico" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>{"SERVICIO\u00A0TÉCNICO"}</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/marcas" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>MARCAS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/nosotros" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>NOSOTROS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/contacto" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "28px", height: "auto", lineHeight: "1.2", fontSize: "0.60rem", fontWeight: "800" }}>CONTACTO</Link></li>
              </ul>
            </nav>

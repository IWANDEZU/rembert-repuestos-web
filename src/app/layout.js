        ...
        <AuthProvider>
          <CartProvider>
            ...
            <nav className="navbar">
              ...
              {/* Bottom Menu */}
              <ul className="navbar__menu main-container" style={{ display: "flex", justifyContent: "center", alignItems: "center", whiteSpace: "nowrap", flexWrap: "nowrap", width: "100%", padding: "0.25rem 0" }}>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>INICIO</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=lubricantes" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>LUBRICANTES</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=filtros" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>FILTROS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/catalogo?category=frenos-y-suspension" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>{"FRENOS\u00A0Y\u00A0SUSPENSIÓN"}</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/radiadores" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>RADIADORES</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/servicio-tecnico" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>{"SERVICIO\u00A0TÉCNICO"}</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/marcas" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>MARCAS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/nosotros" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>NOSOTROS</Link></li>
                <li style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", flexShrink: 0, width: "max-content" }}><Link href="/contacto" className="navbar__link" style={{ display: "inline-flex", alignItems: "center", whiteSpace: "nowrap", width: "max-content", minHeight: "32px", height: "auto", lineHeight: "1.2" }}>CONTACTO</Link></li>
              </ul>
            </nav>

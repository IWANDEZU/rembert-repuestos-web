...
export const gtiProducts = [
  ...
  gtiProduct({ sku: "GTI03-003", name: "Punta lado rueda GTI — Kia Rio Stylus 1.5", make: "Kia", model: "Rio Stylus", engine: "1.5 gasolina", position: "Eje delantero · lado rueda", splines: "22 dientes · pin interno", status: "verified" }),
  gtiProduct({ sku: "GTI03-072", name: "Punta lado rueda GTI — Mazda 2", make: "Mazda", model: "Mazda 2", position: "Eje delantero · lado rueda", splines: "25 × 39", status: "verified" }),

  gtiProduct({ sku: "GTI04-001", name: "Punta lado rueda GTI — Chevrolet Corsa", make: "Chevrolet", model: "Corsa", engine: "1.3 / 1.4 / 1.6 gasolina", position: "Eje delantero · lado rueda", splines: "28 dientes", status: "verified" }),
  gtiProduct({ sku: "GTI04-002", name: "Punta lado rueda GTI — Chevrolet Corsa / Daewoo Racer, Cielo y Lanos", make: "Chevrolet / Daewoo", model: "Corsa / Racer / Cielo / Lanos", position: "Eje delantero · lado rueda", splines: "Confirmar estrías y pin por vehículo", status: "verified" }),
  gtiProduct({ sku: "GTI04-024", name: "Tulipa lado caja GTI — Chevrolet Corsa", make: "Chevrolet", model: "Corsa", engine: "1.3 / 1.4 gasolina", position: "Eje delantero · lado caja", splines: "Configuración Corea; contar estrías", transmission: "Manual; confirmar", status: "verified" }),
  gtiProduct({ sku: "GTI04-025", name: "Tulipa lado caja GTI — Chevrolet Spark / Spark Cronos", make: "Chevrolet", model: "Spark / Spark Cronos", position: "Eje delantero · lado caja", splines: "22 × 19", status: "verified" }),
  gtiProduct({ sku: "GTI04-035", name: "Punta lado rueda GTI — Chevrolet Optra / Astra", make: "Chevrolet", model: "Optra / Astra", position: "Eje delantero · lado rueda", splines: "23 dientes según catálogo GTI; confirmar medidas", status: "verified" }),
  gtiProduct({ sku: "GTI04-046", name: "Punta lado rueda GTI — Chevrolet Aveo Korea con ABS", make: "Chevrolet", model: "Aveo de origen Corea", position: "Eje delantero · lado rueda", splines: "22 × 22", abs: "Con ABS; confirmar cantidad de dientes", status: "verified" }),
  gtiProduct({ sku: "GTI04-055", name: "Tulipa lado caja GTI — Chevrolet Spark / Spark Cronos", make: "Chevrolet", model: "Spark / Spark Cronos", position: "Eje delantero · lado caja", splines: "21 dientes", status: "verified" }),
  gtiProduct({ sku: "GTI04-066", name: "Tulipa lado caja GTI — Chevrolet Spark GT", make: "Chevrolet", model: "Spark GT", position: "Eje delantero · lado caja", splines: "Confirmar estrías y diámetro de sello", status: "verified" }),
  gtiProduct({ sku: "GTI04-088", name: "Tulipa lado caja GTI — Chevrolet Sail", make: "Chevrolet", model: "Sail", position: "Eje delantero · lado caja", splines: "22 × 22", status: "verified" }),
  ...
  gtiProduct({ sku: "GTI04-090", name: "Tulipa lado caja GTI — Chevrolet Cobalt", make: "Chevrolet", model: "Cobalt", position: "Eje delantero · lado caja", splines: "Confirmar por etiqueta y VIN", status: "verified" }),
  ...
  gtiProduct({ sku: "GTI06-001", name: "Punta lado rueda GTI — Hyundai Accent / Verna / Gyro / Vision / i25", make: "Hyundai", model: "Accent / Verna / Gyro / Vision / i25", position: "Eje delantero · lado rueda", splines: "22 dientes · pin interno", status: "verified" }),
  gtiProduct({ sku: "GTI06-003", name: "Punta lado rueda GTI — Hyundai Atos", make: "Hyundai", model: "Atos", position: "Eje delantero · lado rueda", splines: "20 dientes", status: "verified" }),
  gtiProduct({ sku: "GTI06-012", name: "Punta lado rueda GTI — Kia Cerato / Forte", make: "Kia", model: "Cerato / Forte", position: "Eje delantero · lado rueda", splines: "22 × 27", status: "verified" }),
  gtiProduct({ sku: "GTI06-014", name: "Tulipa lado caja GTI — Hyundai Atos", make: "Hyundai", model: "Atos", position: "Eje delantero · lado caja", splines: "20 dientes", status: "verified" }),
  gtiProduct({ sku: "GTI06-032", name: "Punta lado rueda GTI — Hyundai i10", make: "Hyundai", model: "i10", position: "Eje delantero · lado rueda", splines: "Confirmar estrías", status: "verified" }),
  gtiProduct({ sku: "GTI06-034", name: "Tulipa lado caja GTI — Kia Rio Stylus", make: "Kia", model: "Rio Stylus", position: "Eje delantero · lado caja", splines: "22 dientes", status: "verified" }),
  gtiProduct({ sku: "GTI06-037", name: "Tulipa lado caja GTI — Kia Rio Xcite / Cerato / Forte / Hyundai i25", make: "Kia / Hyundai", model: "Rio Xcite / Cerato 1.6 / Forte / i25", position: "Eje delantero · lado caja", splines: "Confirmar por versión", status: "verified" }),
  gtiProduct({ sku: "GTI06-038", name: "Tulipa lado caja GTI — Hyundai Accent Vision", make: "Hyundai", model: "Accent Vision", position: "Eje delantero · lado caja", splines: "25 × 22 según inventario", status: "verified" }),
  gtiProduct({ sku: "GTI06-069", name: "Tulipa lado caja GTI — Hyundai Grand i10", make: "Hyundai", model: "Grand i10", position: "Eje delantero · lado caja", splines: "Confirmar estrías y transmisión", status: "verified" }),
  ...
  gtiProduct({ sku: "GTI06031", name: "Tulipa lado caja GTI — Hyundai i10", make: "Hyundai", model: "i10", position: "Eje delantero · lado caja", splines: "Confirmar estrías y transmisión", status: "verified" }),

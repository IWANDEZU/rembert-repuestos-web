...
export const frenosSuspensionProducts = [
  {
    id: "yzh-5768-base-amortiguador-delantero-chevrolet-tracker",
    name: "Base de Amortiguador Delantero VAZLO 5768 — Chevrolet Tracker (RH/LH)",
    slug: "yzh-5768-base-amortiguador-delantero-chevrolet-tracker",
    category,
    brand: { name: "VAZLO", slug: "vazlo" },
    price: 130989,
    sku: "5768",
    referenceType: "manufacturer",
    fitmentStatus: "verified",
    fitments: [
      { make: "Chevrolet", model: "Tracker / Trax (1ra Generación)", years: "2013–2019", position: "Delantero derecho (RH) e izquierdo (LH)", engine: "1.8L Ecotec Gasolina FWD / AWD" },
      { make: "Chevrolet", model: "Tracker Turbo (2da Generación)", years: "2020–2024", position: "Delantero derecho (RH) e izquierdo (LH)", engine: "1.2L Turbo Ecotec" },
      { make: "Chevrolet", model: "Sonic / Spin / Cobalt", years: "2012–2018", position: "Delantero bilateral (confirmar OE)", engine: "1.6L / 1.8L Gasolina" },
    ],
    fitmentSummary: "407-YZH-5768 / 5768: Chevrolet Tracker (2013–2019 / 2020+) · Eje Delantero · Lado Derecho (RH) e Izquierdo (LH).",
    fitmentRequirements: ["VIN", "año de fabricación", "motorización (1.8L / Turbo)", "lado bilateral RH/LH", "referencia OE o muestra física"],
    fitmentSource: "Marca VAZLO confirmada por REMBERT; código físico 407-YZH-5768 conservado en la pieza · Cruces OE 95227628 / 95015324 / 95943131 / 26298703 / 13502180",
    shortDesc: "Soporte / base superior de amortiguador delantero para Chevrolet Tracker con rodamiento y aislamiento de caucho reforzado.",
    description: "Base superior de amortiguador delantero (soporte / copela / strut mount) marca VAZLO, con código físico 407-YZH-5768, para Chevrolet Tracker (plataforma 1.8L y nuevas versiones). Fabricada con caucho vulcanizado de alta resiliencia y copela de acero estampado con garantía de 1 año o 20.000 km, diseñada para absorber los impactos verticales de la suspensión McPherson, reducir vibraciones en la carrocería y brindar suavidad y precisión en la dirección.",
    ...
    attributes: [
      { id: "base-ref-engraved", name: "Código grabado en pieza", value: "407-YZH-5768" },
      { id: "base-sku", name: "Referencia de catálogo / inventario", value: "5768 (código interno *804210*)" },
      { id: "base-brand", name: "Marca comercial", value: "VAZLO (confirmada por REMBERT)" },
      { id: "base-warranty", name: "Garantía de fábrica", value: "1 año o 20.000 km (certificada en empaque original)" },
      { id: "base-oe", name: "Referencias OE equivalentes", value: "95227628 · 95015324 · 95943131 · 26298703 · 13502180 · 95142646" },
      { id: "base-system", name: "Sistema", value: "Suspensión delantera · Soporte superior de puntal McPherson (Copela)" },
      { id: "base-position", name: "Posición y montaje", value: "Eje delantero · Aplica para ambos lados (Derecho RH / Izquierdo LH)" },
      { id: "base-fitment", name: "Aplicación principal", value: "Chevrolet Tracker 1.8L (2013–2019) y Tracker Turbo (2020+)" },
      { id: "base-status", name: "Estado de compatibilidad", value: "Aplicación técnica verificada por referencia física grabada y catálogo fabricante" },
    ],
    inStock: true,
    stock: 2,
  },
  {
    ...
    image: "/catalogo-frenos-suspension/amortiguador-delantero-derecho-hyundai-tucson-ix35-kia-sportage-revolution.png",
    images: [
      {
        url: "/catalogo-frenos-suspension/amortiguador-delantero-derecho-hyundai-tucson-ix35-kia-sportage-revolution.png",

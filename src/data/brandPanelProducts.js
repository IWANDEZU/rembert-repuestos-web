...
function familyProduct({ id, name, brand, sku, category, image, summary, description, components, validation, source }) {
  return {
    ...
    fitmentSummary: `${brand} ofrece esta familia en múltiples referencias. Los vehículos enumerados son cobertura orientativa y requieren validación individual.`,
    ...
    attributes: [
      ...
      { id: `${id}-status`, name: "Estado de compatibilidad", value: "Familia por cotizar; validar referencia antes de comprar" },
      { id: `${id}-vehicles`, name: "Cobertura orientativa", value: commonVehicles },

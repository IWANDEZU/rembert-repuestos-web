export const products = [
  ...
  // RADIADORES Y SISTEMA DE ENFRIAMIENTO
  {
    ...
    name: "Radiador Chevrolet Onix / Tracker / Spark GT 1.0 - 1.2 Turbo & 1.4",
    slug: "radiador-chevrolet-onix-tracker",
    category: { name: "Radiadores", slug: "radiadores" },
    brand: { name: "Chevrolet", slug: "chevrolet" },
    price: 310000,
    sku: "RAD-CHV-ONX-TRK",
    description: "Radiador de aluminio con panel de alta disipación para Chevrolet Onix, Tracker y Spark GT. Rendimiento térmico superior y ajuste original directo.",
    image: "/radiador-auto.jpg",
    images: [{ url: "/radiador-auto.jpg", alt: "Radiador Chevrolet Onix Tracker", isMain: true }],
    inStock: true,
    stock: 15,
  },
  {

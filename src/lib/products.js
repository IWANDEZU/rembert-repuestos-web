...
const allProducts = [
  ...
  },
  {
    ...
    price: 0,
    sku: "64193DWBRT",
    shortDesc: "Par LED retrofit H4/H19 con base P43t; confirmar farola, espacio y normativa aplicable.",
    description: "OSRAM LEDriving HL BRIGHT H4/H19 para luces altas y bajas en sistemas de 12 V. La ficha oficial indica 15/15 W, base P43t, luz blanca fría de 6000 K, flujo nominal 1400/1100 lm y vida útil Tc de 5000 horas. La compatibilidad depende del tipo de bombillo, farola, tapa posterior y espacio de refrigeración; el uso vial puede estar restringido según homologación y normativa local.",
    ...
    attributes: [
      ...
      { id: "osramh4-2", name: "Base y sistema", value: "H4/H19 · P43t · 12 V · luz alta y baja" },
      { id: "osramh4-3", name: "Datos eléctricos", value: "15/15 W · 6000 K · 1400/1100 lm" },
      { id: "osramh4-4", name: "Marcas compatibles", value: "Multimarca: Chevrolet, Renault, Kia, Hyundai, Mazda, Toyota, Nissan, Suzuki, Daihatsu, Daewoo, Peugeot, SEAT, Škoda y otras, solamente en versiones equipadas con H4/H19 P43t" },
      { id: "osramh4-5", name: "Validación", value: "Confirmar manual, bombillo retirado, base P43t, farola, tapa, espacio de ventilación y homologación" },
      { id: "osramh4-6", name: "Fuente técnica", value: "OSRAM Automotive — LEDriving HL BRIGHT H4/H19" },
    ],
    inStock: true,
    stock: 0,
  },
  ...
  },
  {
    ...
    price: 0,
    sku: "KTX-CLUTCH-COT",
    shortDesc: "Kit KTX con disco, prensa y rodamiento; requiere referencia lateral o VIN para confirmar aplicación.",
    description: "Familia de kits de embrague KTX Clutch Parts. La presentación fotografiada muestra disco, prensa y rodamiento, pero el frente de la caja no permite identificar el diámetro, estriado ni número de parte. Se publica bajo cotización y no se asigna a un modelo concreto hasta validar la etiqueta del empaque, VIN, motor y transmisión.",
    ...
    attributes: [
      { id: "ktxclutch-1", name: "Contenido mostrado", value: "Disco, prensa y rodamiento de desembrague" },
      { id: "ktxclutch-2", name: "Marcas compatibles", value: "Por confirmar con referencia KTX; no se determina de forma segura por la cara frontal del empaque" },
      { id: "ktxclutch-3", name: "Validar", value: "Referencia lateral, VIN, marca, modelo, año, motor, caja, diámetro y número de estrías" },
      { id: "ktxclutch-4", name: "Disponibilidad", value: "Bajo pedido y cotización; stock y precio sujetos a referencia" },
      { id: "ktxclutch-5", name: "Imagen", value: "Fotografía suministrada por REMBERT; no identifica un SKU específico" },
    ],
    inStock: true,
    stock: 0,
  },

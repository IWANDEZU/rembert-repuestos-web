...
- 47 referencias GTI presentes en `INVENTARIO GENERAL`.
...
Las nuevas composiciones de estudio se construyeron a partir de las fotografías verificadas de producto y se exportaron a WebP 1200 × 1200. Conservan el tipo de repuesto, los componentes visibles y el empaque GTI; además incluyen la marca REMBERT en la esquina inferior derecha. La imagen comercial no sustituye la validación por referencia, medidas o VIN.

| Referencia | Archivo web | Fuente de producto |
|---|---|---|
| GTI01-028 | `gti01-028-tulipa-logan-sandero-studio-v2.webp` | Importadoras Asociadas Colombia |
| GTI01-038 | `gti01-038-punta-eje-logan-sandero-studio-v2.webp` | Importadoras Asociadas Colombia |
| GTI01-064 | `gti01-064-punta-eje-duster-studio-v2.webp` | Importadoras Asociadas Colombia |
| GTI01-102 | `gti01-102-punta-eje-logan-sandero-studio-v2.webp` | Mercado Libre Colombia |
| GTI04-128 | `gti04-128-punta-eje-spark-abs-studio-v2.webp` | Mercado Libre Colombia |

La imagen `gti-linea-homocinetica-studio-v2.webp` es una composición comercial de familia para referencias sin fotografía exacta. La ficha declara expresamente que no prueba la pieza individual.
